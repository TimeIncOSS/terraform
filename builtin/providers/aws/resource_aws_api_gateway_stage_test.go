		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAWSAPIGatewayStageExists("aws_api_gateway_stage.yada", &conf),
					resource.TestCheckResourceAttr("aws_api_gateway_stage.yada", "stage_name", "prod"),
				),
			},
			resource.TestStep{
...
resource "aws_api_gateway_stage" "yada" {
  rest_api_id = "${aws_api_gateway_rest_api.test.id}"
  stage_name = "prod"
